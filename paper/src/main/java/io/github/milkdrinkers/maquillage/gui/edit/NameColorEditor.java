...
public final class NameColorEditor {
    ...
    public static void create(
        ...
        try {
            previewComponent = ColorParser.of(Translation.of("maquillage.dialog.namecolor.editor.preview-format"))
            ...
            previewComponent = Component.translatable("maquillage.dialog.namecolor.editor.preview-fallback");
        }
        ...
        final Dialog dialog = Dialog.create(
            builder -> builder.empty()
                .base(
                    DialogBase.builder(Component.translatable("maquillage.dialog.namecolor.creator.title"))
                        ...
                        .body(
                            List.of(
                                DialogBody.plainMessage(Component.translatable("maquillage.dialog.namecolor.editor.preview-title")),
    ...
    public static void edit(
        ...
        final Dialog dialog = Dialog.create(
            builder -> builder.empty()
                .base(
                    DialogBase.builder(Component.translatable("maquillage.dialog.namecolor.editor.title"))
                        .externalTitle(Component.empty())
                        .canCloseWithEscape(true)
                        .afterAction(DialogBase.DialogAfterAction.CLOSE)
                        .pause(false)
    ...
    private static List<ActionButton> editorActions(
        ...
        return List.of(
            ActionButton.builder(Component.translatable("maquillage.dialog.namecolor.editor.input-success"))
                .action(
                    onSuccess
                )
                .tooltip(
                    Component.translatable("maquillage.dialog.namecolor.editor.input-success-tooltip")
                )
                .build(),
            ActionButton.builder(Component.translatable("maquillage.dialog.namecolor.editor.input-update"))
                .action(onPreview)
                .tooltip(
                    Component.translatable("maquillage.dialog.namecolor.editor.input-update-tooltip")
                )
                .build(),
            ActionButton.builder(Component.translatable("maquillage.dialog.namecolor.editor.input-cancel"))
                .action(
                    onCancel
                )
                .tooltip(
                    Component.translatable("maquillage.dialog.namecolor.editor.input-cancel-tooltip")
                )
                .build()
        );
    }

    private static List<DialogInput> dialogInputs(NameColorGuiData data) {
        return List.of(
            DialogInput.text("color", Component.translatable("maquillage.dialog.namecolor.editor.input-color"))
                .initial(data.color())
                .labelVisible(true)
                .maxLength(255)
                .build(),
            DialogInput.text("label", Component.translatable("maquillage.dialog.namecolor.editor.input-label"))
                .initial(data.label())
                .labelVisible(true)
                .maxLength(255)
                .build(),
            DialogInput.text("permission", Component.translatable("maquillage.dialog.namecolor.editor.input-permission"))
                .initial(data.permission())
                .labelVisible(true)
                .maxLength(255)
                .build(),
            DialogInput.numberRange("weight", Component.translatable("maquillage.dialog.namecolor.editor.input-weight"), 0, 100)
                .step(1F)
                .initial(data.weight())
                .build()
        );
