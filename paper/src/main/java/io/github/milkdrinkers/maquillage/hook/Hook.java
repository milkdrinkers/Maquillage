...
import io.github.milkdrinkers.maquillage.hook.bstats.BStatsHook;
import io.github.milkdrinkers.maquillage.hook.essentialsx.EssentialsHook;
import io.github.milkdrinkers.maquillage.hook.packetevents.PacketEventsHook;
import io.github.milkdrinkers.maquillage.hook.placeholderapi.PAPIHook;
import io.github.milkdrinkers.maquillage.hook.vault.VaultHook;
...
public enum Hook {
    ...
    Essentials(EssentialsHook.class, "Essentials", true),
    ...
    /**
     * Gets essentials hook.
     *
     * @return the essentials hook
     */
    @NotNull
    public static EssentialsHook getEssentialsHook() {
        return (EssentialsHook) Hook.Essentials.get();
    }
