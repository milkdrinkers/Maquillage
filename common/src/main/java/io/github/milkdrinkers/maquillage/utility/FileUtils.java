...
public final class FileUtils {
    ...
    public static void extractResource(
        ...
        try (
            InputStream stream = AbstractMaquillage.getInstance().getResource(resourcePath.toString().replace('\\', '/'))
        ) {
            if (stream == null)
    ...
    public static Set<String> resourceListFiles(
        ...
        final URL url = AbstractMaquillage.getInstance().getClass().getResource("");
